...
The project is based on Rime Input Method Framework. 

## 电脑安装步骤

### 1.  安装鼠须管（一款开源可定制输入法）至电脑
1. 下载 <a href="https://rime.im/" target="_blank">鼠须管</a>
2. 打开setting-keyboard-点击左下角加号
3. 选择Chinese simplified - squirrel- Add
<img width="553" height="407" alt="Screenshot 2026-07-01 at 18 42 50" src="https://github.com/user-attachments/assets/8416dfa4-2b89-452a-a1e6-7d228c66c13e" />

4. 点击Done

### 2.  安装女性友好自定义词库
1. 下载本repository所有代码（右上角Code-download ZIP)
<img width="368" height="313" alt="Screenshot 2026-07-01 at 18 46 00" src="https://github.com/user-attachments/assets/45965648-33cd-49fe-b7fc-4c4fbac62a02" />

3. 解压ZIP

4. 切换至鼠须管输入法，点击Settings...
<img width="259" height="479" alt="Screenshot 2026-07-01 at 19 04 01" src="https://github.com/user-attachments/assets/58aa9ab5-d286-424f-90b6-a6986359e15e" />

5. 此时弹出文件夹，将其中的初始内容替换为解压后文件夹内部的所有内容

（初始内容，请将其删除）<img width="609" height="240" alt="Screenshot 2026-07-01 at 18 47 17" src="https://github.com/user-attachments/assets/02eee1b2-87e1-4d53-90ea-f613e6f17410" />

（替换为新内容）<img width="883" height="821" alt="Screenshot 2026-07-01 at 19 06 45" src="https://github.com/user-attachments/assets/25c52d5e-7a5f-4157-8f6c-b42a51b10020" />

5. 再次点击屏幕右上角鼠须管输入法图标，点击deploy
<img width="254" height="473" alt="Screenshot 2026-07-01 at 19 07 52" src="https://github.com/user-attachments/assets/d0595110-5aa2-4a57-9925-3e1e1364fb45" />

6. 稍等片刻（一分钟左右，或允许消息提醒弹出）

7. 尝试打jidu二字，你会看到 ⬇️
<img width="115" height="165" alt="Screenshot 2026-07-01 at 19 10 53" src="https://github.com/user-attachments/assets/bc0996b8-9b5f-4c93-8494-ebf5009328e0" />

### 3.  （选做）显示「自造字」

![自造字预览](img/zaozi-preview.png)

本词库包含一批带有女字旁的原创设计的自造字，这些字使用了 Unicode 私用区（PUA）码位，**必须安装配套字体 `Feminist eKeyboard` 才能正常显示**，否则会显示为空心方框 □。

1. 在解压后的文件夹里，打开 `fonts` 文件夹
2. 双击 `FeministeKeyboard-Regular.ttf`，在弹出的「字体册」中点击**安装字体**
3. 回到鼠须管，再点一次菜单栏图标 -【重新部署】（deploy）
4. 尝试输入 `qiang`、`yong`、`le`、`hui`、`lv`、`nai`、`ze`、`lan`、`tuo`，即可在候选中看到对应的自造字；输入 `qiang da`、`yong gan`、`zhi hui` 等还能得到带自造字的词语

> ⚠️ **重要提示（PUA 字符的限制）**：这些自造字只有在**安装了 `Feminist eKeyboard` 字体的设备上**才能正确显示。你把这些字发给别人、或粘贴到没有安装该字体的电脑 / 网页 / App 时，对方会看到空心方框 □。若希望对方也能看到，请让对方同样安装此字体。

#### 关于自造字的一点说明

请辩证地看待、使用这些新造字。一方面，为「强、勇、乐、慧」等本无女字旁的中性 / 褒义字另造一套女字旁写法，可以被读作一种**对中性字的让渡**——仿佛默许了原字属于男性、女性须得另立门户。但另一方面，它也在主动地把**女字旁与积极、正面的词汇建立联结**以对冲汉字里大量以女字旁构成的贬义字长久沉淀下来的偏见。

请把它理解为一个**可引发讨论的实验**。这既是对既有文字性别秩序的一次提问，也是一次「如果女字旁的含义很正面」的想象。怎么用、用不用、如何评价，都留给使用它的妳。

**若需在手机安装此词库或扩充更多词汇，请参考以下官方教程**
...
示例：朙月拼音 人类 词库 `luna_pinyin.human.dict.yaml`。

```
# 人类词库

name: luna_pinyin.human  # 要和文件名一致
version: "2021.12.21"
sort: by_weight
use_preset_vocabulary: false
...
                              # 此处空一行
大家都是人  da  jia  dou  shi  ren  1  # 汉字和编码用 Tab 键间隔，拼音之间用空格键
```
...
示例：人类词库 `luna_pinyin.human.dict.yaml` 即输入 `luna_pinyin.human`。
